...
import { cadastrarUser, myProfile, getMemberById, updateMemberController, deactivateMemberController, updatePasswordController, esqueciSenhaController, redefinirSenhaController, listarAniversariantesController } from '../controllers/membroController';
...
router.get('/aniversariantes', authMiddleware, listarAniversariantesController);
